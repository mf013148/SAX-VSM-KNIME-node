 ...
 */
public class SAXVSMClassifierNodePlugin extends Plugin {
    // The shared instance.
    private static SAXVSMClassifierNodePlugin plugin;

    /**
     * The constructor.
     */
    public SAXVSMClassifierNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SAXVSMClassifierNodePlugin getDefault() {
        return plugin;
    }
